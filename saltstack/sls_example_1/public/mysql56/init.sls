...
/root/Downloads/cmake-2.8.4.tar.gz:
  file.managed:
    - source: salt://mysql56/cmake-2.8.4.tar.gz
    - user: root
    - group: root
    - mode: 755
    - template: jinja
