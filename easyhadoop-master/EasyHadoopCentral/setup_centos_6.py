...
os.system('mysql -h192.168.0.111 -uroot -pcloudiyawuhan -e"create database if not exists easyhadoop"')
os.system('mysql -h192.168.0.111 -uroot -pcloudiyawuhan --default-character-set=utf8 easyhadoop < easyhadoop.sql')
os.system('mysql -h192.168.0.111 -uroot -pcloudiyawuhan --default-character-set=utf8 easyhadoop < patch-0001.sql')
os.system('mysql -h192.168.0.111 -uroot -pcloudiyawuhan --default-character-set=utf8 easyhadoop < patch-0002.sql')
os.system('mysql -h192.168.0.111 -uroot -pcloudiyawuhan --default-character-set=utf8 easyhadoop < patch-0003.sql')
