...
function UpgradeNginx() 
{
	...
	./configure  --prefix=${ProNginxDir} --with-http_ssl_module --with-http_stub_status_module --with-http_gzip_static_module --with-http_gunzip_module --with-http_realip_module --add-module=${ABSDIR}/modules/nginx-module-vts  --add-module=${ABSDIR}/modules/ngx_cache_purge-2.3
	make
