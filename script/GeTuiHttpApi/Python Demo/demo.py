...
APPKEY = "jYwfAMxU4U8wE900IgGy42"
APPID = "SEHaeuZDKqAqD9AaqRwFH4"
MASTERSECRET = "aunBpzxXbdAyrE6iCRV0T"
CID = "f9a95b12b53bc74d1ab7c63dff4404ca"
#HOST = 'http://sdk.open.api.igexin.com/apiex.htm'
HOST = "http://119.37.194.88/apiex.htm"
...
def NotificationTemplateDemo():
    ...
    template.transmissionContent = u"xihaha"
    template.title = u"你好"
    template.text = u"胃痛年"
...
def TransmissionTemplateDemo():
    ...
    template.appId = APPID
    template.appKey = APPKEY
    template.transmissionContent = 'xihahahhahahah'
    #iOS 推送需要的PushInfo字段 前三项必填，后四项可以填空字符串
    #template.setPushInfo(actionLocKey, badge, message, sound, payload, locKey, locArgs, launchImage)
