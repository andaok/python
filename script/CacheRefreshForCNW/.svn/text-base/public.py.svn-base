...
#待处理队列名称
PendingHandleListName = "cacheurl_list"
#每次从待处理队列获取的PATHS数目
PerHandleNum = 10

#PATH路径前缀
PathPrefix = "/video/static"
#PATH路径域名
PathDomain = "video.skygrande.com"
#刷新前缀
FlushPrefix = "http://%s%s"%(PathDomain,PathPrefix)
...
#CDN API INTERFACE FOR PAD
pad = "video.skygrande.com"
#CDN API USERNAME
...
def getLog(logflag,loglevel="debug"):
    ...
    logfile = sys.path[0] + "/logs/%s.log"%logflag
